...
<body>
	<div class="container">
		<form:form method="GET" action="/confirmar_agregar_condimento">

			<div class="form-group">
				<label for="inputEmail3" class="col-sm-3 control-label">Nombre
					del condimento:</label>
				<div class="col-sm-9">
					<input type="text" class="form-control" name="nombre" 
						value='${miCondimento.nombre}' readonly required></input>
				</div>
			</div>
		<br></br>
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control"
						placeholder='${miCondimento.precio}$' readonly></input>
				</div>
			</div>
		<br></br>
			<div class="form-group">
				<label for="inputPassword3" class="col-sm-3 control-label">Por favor, confirme su condimento al sanguchetto</label>
